...
void loadMedia() {
	font = TTF_OpenFont("engine_resources/font.ttf", 24);
}
...
void loadGameObjects(){
	...
	GameManager::addObj(new GameObject({new Transform(), new Renderer("resources/space.jpeg", SCREEN_WIDTH, SCREEN_HEIGHT)}));
